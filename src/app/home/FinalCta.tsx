...
export function FinalCta() {
  return (
    <ScrollReveal>
      <section className="mx-auto w-full max-w-3xl px-4 py-20 text-center sm:px-8">
        <h2 className="font-landing-heading text-3xl font-bold text-foreground sm:text-4xl">
