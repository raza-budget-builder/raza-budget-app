  ...
  return (
    <>
      <div className="relative mb-4">
        ...
        <div className="relative z-40 inline-flex flex-col items-start gap-2">
          <button
            onClick={() => setExpanded((e) => !e)}
            aria-label={expanded ? "Close quick actions" : "Quick actions"}
            aria-expanded={expanded}
            className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full border border-card-border bg-accent text-accent-foreground shadow-lg hover:bg-accent-hover"
          >
            <PlusIcon
          ...
          >
            <div className="overflow-hidden">
              <div
                className={`flex flex-col items-start gap-2 pt-1 transition-opacity duration-300 ${
